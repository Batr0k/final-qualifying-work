...
<?php
           $meropriyatiya = mysqli_query( $connect, "SELECT `name`, `opisaniye`, `adres`, `path`, `meropriyatiya`.`id` FROM `meropriyatiya` JOIN `dates` on `meropriyatiya`.`id`=`dates`.`idMeropriyatiya`
